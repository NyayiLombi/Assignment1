...
student_data(student_id = '21102132', student_name = 'Nyayi Lombi')

student_data(student_id='21102132', student_name='Nyayi Lombi', student_class='XII')
...
print(isinstance(Nyayi,Student))
print(isinstance(Nyayi,Marks))
